...
import com.score.shopz.pojos.DrawerItem;
...
public class HomeActivity extends FragmentActivity {
    ...
    private void initDrawerList() {
        ...
        drawerItemList.add(new DrawerItem("$ ShopZ", "#5f82c3", R.drawable.drawer_list_row_selector, R.drawable.drawer_list_row_selector, true));
